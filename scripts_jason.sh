...
python run_lvm.py --opt_dtok iwslt16_deen --opt_batchtokens 4092 --opt_distill --opt_annealbudget --opt_fastanneal --opt_latentdim 2 --opt_fixbug2 --opt_lr 0.001 --train --tensorboard
